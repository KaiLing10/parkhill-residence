    ...
    return (
        <div className='bg-gray-100 font-title text-black'>
            ...
            <div className='flex justify-center pt-20 pb-10'>
                <img src={logoPic} alt='logo' className=' md:w-1/3'></img>
            </div>
            {/* main description */}
            <div className=' relative h-screen w-screen'>
                ...
                <div className='absolute z-40 top-1/3 flex justify-center items-center text-lg md:text-2xl font-semibold text-center'>
                    <motion.div
                        className='bg-white/60 w-3/4 md:w-2/3 p-5 md:p-10'
                    ...
                    >
                        ...
                        <p>There are in total 4 condominium towers built on 5.65 acres out of the 13-acre site but only two of the towers (Blocks C and D) are open to the public. </p>
                    </motion.div>
                </div>
            </div>
