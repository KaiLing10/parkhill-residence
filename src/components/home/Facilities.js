...
const Facilities = () => {
  ...
  return (
    <div className='font-title bg-gradient-to-b from-gray-800 via-gray-600 to-gray-300 h-screen p-10 relative flex justify-center items-center'>
      ...
      {/* <motion.div
        ...
        <motion.div
          className=' w-2/3 md:w-1/3 drop-shadow-black text-center text-white text-3xl md:text-4xl z-10'
